<div class="card">
    <div class="card-header">
        ...
        @endphp
        <a href="{{ route('documents.invoices.index', ['page' => 'dashboard']) }}"
        ...
        <a href="{{ route('documents.invoices.index', ['page' => 'create']) }}"
            class="{{ request()->get('page') == 'create' ? 'active' : '' }}">New</a> |
        <a href="{{ route('documents.invoices.index', ['page' => 'not-posted']) }}"
        ...
        <a href="{{ route('documents.invoices.index', ['page' => 'list']) }}"
