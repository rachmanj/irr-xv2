<div class="card">
    <div class="card-header">
        ...
        | <a href="{{ route('documents.additional-documents.index', ['page' => 'search']) }}"
            class="{{ request()->get('page') == 'search' ? 'active' : '' }}">Search</a>
        | <a href="{{ route('documents.additional-documents.index', ['page' => 'create']) }}"
            class="{{ request()->get('page') == 'create' ? 'active' : '' }}">Create</a>
        | <a href="{{ route('documents.additional-documents.index', ['page' => 'list']) }}"
